...
# 07_modern_global_structural_20: fit_fusion_halfyear_direct_from_ckpt.sh
source /data1/miniconda3/bin/activate dualsg2

python run.py \
  --task_name fit_fusion \
  --is_training 1 \
  --model_id fit_fusion_halfyear_direct_from_ckpt \
  ...
  --caption_emb_path ./dataset/FIT_DualSG/pt/fit_dualsg_global_structural.pt \
