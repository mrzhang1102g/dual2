...
目标：
- 只打印当前实际生效、且对实验排查有帮助的参数
- FIT 和 Geo 共用一份打印逻辑，但按 task_name 控制展示重点
"""
...
def print_args(args):
    ...
    if args.task_name == "fit_fusion":
        ...
        print(f'  {"Text Mode:":<22}{args.text_mode:<24}{"Freeze Numerical:":<22}{args.freeze_numerical:<24}')
        ...
        print(f'  {"WD Text:":<22}{args.weight_decay_text:<24}{"Num Feat Dim:":<22}{args.num_feat_dim:<24}')
